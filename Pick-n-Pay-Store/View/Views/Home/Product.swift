...
//make viewModel
var products = [
    Product(name: "Men Pullover Sweater", comments: ["Comment 1", "Comment 2", "Comment 3", "Comment 4"], offer: false, price: 19.99, tags: ["shirt", "clothing", "winter"], image: "pullover", color: UIColor(Color("pcolor3")), desc: "Brown pullover sweater, has a round neck, long sleeves, straight hem..", isLiked: false, rating: 4),
    Product(name: "Black Fit Top", comments: ["Comment 1", "Comment 2", "Comment 3", "Comment 4"], offer: false, price: 29.99, tags: ["shirt", "clothing", "fitness"], image: "blacktop", color: UIColor(Color("pcolor2")), desc: "Black fitness top perfect for working out.", isLiked: false, rating: 5),
    Product(name: "Longline Over Coat", comments: ["Comment 1", "Comment 2", "Comment 3", "Comment 4"], offer: false, price: 39.99, tags: ["coat", "cloathing", "winter"], image: "overcoat", color: UIColor(Color("pcolor1")), desc: "Black longline over coat, has a notched lapel collar, button closure, long sleeves.", isLiked: false, rating: 3),
    Product(name: "Graphic Baseball Collar Shirt", comments: ["Comment 1", "Comment 2", "Comment 3", "Comment 4"], offer: false, price: 49.99, tags: ["shirt", "clothing", "summer"], image: "jersey", color: UIColor(Color("pcolor4")), desc: "Men 1pc Letter Graphic Baseball Collar Shirt", isLiked: false, rating: 4),
    Product(name: "The Chrono S", comments: ["Comment 1", "Comment 2", "Comment 3", "Comment 4"], offer: false, price: 59.99, tags: ["watch", "accessory", "mens"], image: "watch1", color: UIColor(Color("pcolor3")), desc: "The Chrono S is built to last and designed to be the most versatile watch you’ll ever own.", isLiked: false, rating: 4),
    Product(name: "Timex Unisex Fairfield 41mm", comments: ["Comment 1", "Comment 2", "Comment 3", "Comment 4"], offer: false, price: 69.99, tags: ["watch", "accessory", "mens", "womans"], image: "watch2", color: UIColor(Color("pcolor2")), desc: "The Fairfield collection carries the refreshing, minimalist design that the Timex brand was built on with a remarkably clean dial and interchangeable slip-thru and quick-release strap options.", isLiked: false, rating: 5),
    Product(name: "SLITHERING SILVER", comments: ["Comment 1", "Comment 2", "Comment 3", "Comment 4"], offer: false, price: 79.99, tags: ["bracelet", "accessory", "mens"], image: "bracelet1", color: UIColor(Color("pcolor1")), desc: "Solid 925 Sterling Silver Bracelet for Men - Sizes 7 to 10.", isLiked: false, rating: 3),
    Product(name: "Cuban Link Bracelet", comments: ["Comment 1", "Comment 2", "Comment 3", "Comment 4"], offer: false, price: 89.99, tags: ["bracelet", "accessory", "mens"], image: "bracelet2", color: UIColor(Color("pcolor4")), desc: "Finally, a classic, lightweight bracelet without sacrificing bold links and luxurious shine.", isLiked: false, rating: 4),
    Product(name: "Drake Cuffed Pants", comments: ["Comment 1", "Comment 2", "Comment 3", "Comment 4"], offer: false, price: 27.99, tags: ["pants", "clothing", "mens"], image: "joggers", color: UIColor(Color("pcolor4")), desc: "The best selling Drake Cuffed Pant is our all time favorite jogger.", isLiked: false, rating: 4),
    Product(name: "Loose Fit Track", comments: ["Comment 1", "Comment 2", "Comment 3", "Comment 4"], offer: false, price: 14.99, tags: ["pants", "clothing", "mens"], image: "joggers2", color: UIColor(Color("pcolor4")), desc: "Our Loose Fit Track made from 100% Cotton 280 GSM brushed back fleece offers all day comfort.", isLiked: false, rating: 4)
]
//var products = [
