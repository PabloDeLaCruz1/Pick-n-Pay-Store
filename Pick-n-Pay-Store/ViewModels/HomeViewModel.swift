...
class HomeViewModel: ObservableObject {
    ...
    @Published var products: [Product] = [ // FOR TESTING PURPOSES, Products will come from API
        ...
        Product(name: "Item #4", comments: ["Comment 1", "Comment 2", "Comment 3", "Comment 4"], offer: false, price: 49.99, tags: ["Health Care", "expensive", "tag3"], image: "product4", color: UIColor(Color("pcolor4")), desc: "This is Item #4's description. It does this and that.", isLiked: true, rating: 4, isSaved: 0, quantity: 1),
